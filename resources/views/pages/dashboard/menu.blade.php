        ...
        <div class="nk-wg1">
          <div class="nk-wg1-block">
            ...
            <div class="nk-wg1-text">
              <h5 class="title">Registrasi Nasabah</h5>
              <p>
                Isi form untuk mendaftarkan nasabah baru.
              </p>
            </div>
          </div>
      ...
      <div class="card card-bordered card-full">
        <div class="nk-wg1">
          <div class="nk-wg1-block">
            ...
            <div class="nk-wg1-text">
              <h5 class="title">Lihat Nasabah</h5>
              <p>
                Lihat daftar nasabah aktif
                <strong>KSP Veteran</strong>.
              </p>
            </div>
          </div>
          <div class="nk-wg1-action">
      ...
      <div class="card card-bordered card-full">
        <div class="nk-wg1">
          <div class="nk-wg1-block">
            ...
            <div class="nk-wg1-text">
              <h5 class="title">Tabungan (Simpan)</h5>
              <p>
                Input tabungan baru dari nasabah.
              </p>
            </div>
          </div>
          <div class="nk-wg1-action">
      ...
      <div class="card card-bordered card-full">
        <div class="nk-wg1">
          <div class="nk-wg1-block">
            ...
            <div class="nk-wg1-text">
              <h5 class="title">Angsuran (Pinjam)</h5>
              <p>
                Pengajuan angsuran baru bagi nasabah.
              </p>
            </div>
          </div>
          <div class="nk-wg1-action">
